...
public class CentroController {
	...
	@GetMapping("/centros/codigo/{codigo}")
	public Centro show(@PathVariable String codigo) {
		return this.centroService.findByCodigo(codigo);
	}
	
	@PostMapping("/centros/codigo/{codigo}")
