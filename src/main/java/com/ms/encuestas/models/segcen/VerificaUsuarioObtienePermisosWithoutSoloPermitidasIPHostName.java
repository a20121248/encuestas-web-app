...
@XmlRootElement(name = "VerificaUsuarioObtienePermisosWithoutSoloPermitidasIPHostName")
public class VerificaUsuarioObtienePermisosWithoutSoloPermitidasIPHostName {
